...
class ModelBuilding:
    ...
    def set_building_model(self, user_charactor, speak_prediction_time, exp_date):
        ...
        # AUで重要な特徴量をdfから抽出
        df_au_loc = df_feature_value_AU.loc[:, importance_feature_AU_b_space]
        # AUと顔特徴を結合
        ...
        X_test_past = df_X_original_concat.loc[:, x_colums_b_space]
...
def make_random_forest_model_past_data(
    ...
    x_index.extend(importance_feature_AU_b)
    ...
    X_train_past = speak_feature_value_dropped.loc[:, x_colums_b]
